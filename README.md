...
This dictionary, MedDic-ADE, was manually augmented from the Japanese disease dictionary [Manbyo](https://sociocom.naist.jp/manbyo-dic-en/) and the Japanese medicine dictionary [Hyakuyaku](https://sociocom.naist.jp/hyakuyaku-dic-en/). 
Each entry in this MedDic-ADE includes a surface expression, its medical concept, and seven popular adverse drug effects (ADEs) in cancer treatment.
